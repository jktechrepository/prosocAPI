...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260309122000_AddDeviseIdToProduitAssureur') THEN
...
BEGIN
    ...
    ALTER TABLE `ProduitsAssureurs` ADD `DeviseId` int NOT NULL DEFAULT 0;
...
BEGIN
    ...
    ALTER TABLE `ProduitsAssureurs` ADD CONSTRAINT `FK_ProduitsAssureurs_Devises_DeviseId` FOREIGN KEY (`DeviseId`) REFERENCES `Devises` (`IdDevise`) ON DELETE RESTRICT;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260309122000_AddDeviseIdToProduitAssureur', '6.0.25');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260310134920_AddPhotoUrlToAgent') THEN
...
BEGIN
    ...
    ALTER TABLE `Agents` ADD `PhotoUrl` varchar(500) CHARACTER SET utf8mb4 NULL;
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260310144846_AddPhotoUrlToAffilie') THEN
...
BEGIN
    ...
    ALTER TABLE `Affilies` ADD `PhotoUrl` varchar(500) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260310144846_AddPhotoUrlToAffilie', '6.0.25');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260310183713_AddJetonMedicalSystem') THEN
...
BEGIN
    ...
    ALTER TABLE `Prestations` ADD `HopitalPartenaireIdHopital` int NULL;
...
BEGIN
    ...
    ALTER TABLE `Adhesions` ADD `AffilieIdAffilie` int NULL;
...
BEGIN
    ...
    ALTER TABLE `Adhesions` ADD CONSTRAINT `FK_Adhesions_Affilies_AffilieIdAffilie` FOREIGN KEY (`AffilieIdAffilie`) REFERENCES `Affilies` (`IdAffilie`);
...
BEGIN
    ...
    ALTER TABLE `Prestations` ADD CONSTRAINT `FK_Prestations_HopitalPartenaires_HopitalPartenaireIdHopital` FOREIGN KEY (`HopitalPartenaireIdHopital`) REFERENCES `HopitalPartenaires` (`IdHopital`);
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260310193335_AddDemandeBonEnvoiSystem') THEN
...
BEGIN
    ...
    CREATE TABLE `DemandesBonEnvoi` (
        ...
        CONSTRAINT `FK_DemandesBonEnvoi_Prestations_PrestationId` FOREIGN KEY (`PrestationId`) REFERENCES `Prestations` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260310204629_AddRetraitAgentSystem') THEN
...
BEGIN
    ...
    ALTER TABLE `WalletsAgents` ADD `SoldeDisponible` decimal(18,2) NOT NULL DEFAULT 0.0;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260310204629_AddRetraitAgentSystem', '6.0.25');
