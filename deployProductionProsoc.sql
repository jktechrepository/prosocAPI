...
ALTER TABLE `Utilisateurs` ADD `HopitalPartenaireId` int NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260609093538_AddUtilisateurHopitalPartenaireId', '6.0.25');
...
ALTER TABLE `TarifsCotisation` ADD `DeviseId` int NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260609100034_AddTarifCotisationDeviseId', '6.0.25');
...
ALTER TABLE `Collectes` ADD `OperateurUtilisateurId` int NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260609135516_AddCollecteOperateurUtilisateurId', '6.0.25');
...
ALTER TABLE `Utilisateurs` ADD `AssureurId` int NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260609150229_AddUtilisateurAssureurId', '6.0.25');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260610125844_DropDeviseTauxChange', '6.0.25');

COMMIT;

START TRANSACTION;

ALTER TABLE `WalletsVirtuelsAgents` ADD `DeviseId` int NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260610132427_AddWalletVirtuelAgentDeviseId', '6.0.25');
...
ALTER TABLE `TargetsAgents` ADD `RoleId` int NULL;
...
ALTER TABLE `TargetsAgents` MODIFY COLUMN `RoleId` int NOT NULL;

ALTER TABLE `WalletsAgents` MODIFY COLUMN `RowVersion` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6);

CREATE INDEX `IX_TargetsAgents_RoleId_Periodicite` ON `TargetsAgents` (`RoleId`, `Periodicite`);

ALTER TABLE `TargetsAgents` ADD CONSTRAINT `FK_TargetsAgents_Roles_RoleId` FOREIGN KEY (`RoleId`) REFERENCES `Roles` (`IdRole`) ON DELETE RESTRICT;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260613124018_TargetAgentRoleId', '6.0.25');

COMMIT;

START TRANSACTION;

ALTER TABLE `ZonesSociales` ADD `ChefEquipeAgentId` int NULL;

ALTER TABLE `WalletsAgents` MODIFY COLUMN `RowVersion` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6);

ALTER TABLE `Communes` ADD `SuperviseurAgentId` int NULL;

CREATE UNIQUE INDEX `IX_ZonesSociales_ChefEquipeAgentId` ON `ZonesSociales` (`ChefEquipeAgentId`);

CREATE UNIQUE INDEX `IX_Communes_SuperviseurAgentId` ON `Communes` (`SuperviseurAgentId`);

ALTER TABLE `Communes` ADD CONSTRAINT `FK_Communes_Agents_SuperviseurAgentId` FOREIGN KEY (`SuperviseurAgentId`) REFERENCES `Agents` (`IdAgent`) ON DELETE SET NULL;

ALTER TABLE `ZonesSociales` ADD CONSTRAINT `FK_ZonesSociales_Agents_ChefEquipeAgentId` FOREIGN KEY (`ChefEquipeAgentId`) REFERENCES `Agents` (`IdAgent`) ON DELETE SET NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260616135648_TerritorialEncadrementFk', '6.0.25');
...
ALTER TABLE `CategoriesAgents` MODIFY COLUMN `LibelleCategorie` varchar(200) CHARACTER SET utf8mb4 NOT NULL;

ALTER TABLE `CategoriesAgents` MODIFY COLUMN `Description` varchar(500) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `CategoriesAgents` ADD `Code` varchar(10) CHARACTER SET utf8mb4 NULL;
...
ALTER TABLE `CategoriesAgents` MODIFY COLUMN `Code` varchar(10) CHARACTER SET utf8mb4 NOT NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260624134551_AddCategorieAgentCode', '6.0.25');
...
ALTER TABLE `Prestations` ADD `Periodicite` varchar(20) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'Mensuel';
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260625092924_AddPrestationPeriodicite', '6.0.25');
...
ALTER TABLE `Collectes` ADD `DatePerception` datetime(6) NULL;

ALTER TABLE `Collectes` ADD `PercepteurUtilisateurId` int NULL;

ALTER TABLE `Collectes` ADD `PerceptionVirtuelleId` int NULL;

ALTER TABLE `Collectes` ADD `StatutPerception` varchar(20) CHARACTER SET utf8mb4 NULL;
...
CREATE TABLE `PerceptionsVirtuelles` (
    ...
    `DateModification` datetime(6) NULL,
    `Statut` tinyint(1) NOT NULL,
    CONSTRAINT `PK_PerceptionsVirtuelles` PRIMARY KEY (`IdPerceptionVirtuelle`),
    CONSTRAINT `FK_PerceptionsVirtuelles_Agents_AgentId` FOREIGN KEY (`AgentId`) REFERENCES `Agents` (`IdAgent`) ON DELETE RESTRICT,
    CONSTRAINT `FK_PerceptionsVirtuelles_Devises_DeviseId` FOREIGN KEY (`DeviseId`) REFERENCES `Devises` (`IdDevise`) ON DELETE RESTRICT,
    CONSTRAINT `FK_PerceptionsVirtuelles_Utilisateurs_PercepteurUtilisateurId` FOREIGN KEY (`PercepteurUtilisateurId`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE RESTRICT
) CHARACTER SET=utf8mb4;
...
CREATE TABLE `PerceptionsVirtuellesLignes` (
    ...
    `DateCreation` datetime(6) NOT NULL,
    `Statut` tinyint(1) NOT NULL,
    CONSTRAINT `PK_PerceptionsVirtuellesLignes` PRIMARY KEY (`IdLigne`),
    CONSTRAINT `FK_PerceptionsVirtuellesLignes_Agents_AgentId` FOREIGN KEY (`AgentId`) REFERENCES `Agents` (`IdAgent`) ON DELETE RESTRICT,
    CONSTRAINT `FK_PerceptionsVirtuellesLignes_Collectes_CollecteId` FOREIGN KEY (`CollecteId`) REFERENCES `Collectes` (`IdCollecte`) ON DELETE RESTRICT,
    CONSTRAINT `FK_PerceptionsVirtuellesLignes_PerceptionsVirtuelles_Perception~` FOREIGN KEY (`PerceptionVirtuelleId`) REFERENCES `PerceptionsVirtuelles` (`IdPerceptionVirtuelle`) ON DELETE CASCADE,
    CONSTRAINT `FK_PerceptionsVirtuellesLignes_WalletVirtuelMouvements_WalletVi~` FOREIGN KEY (`WalletVirtuelMouvementId`) REFERENCES `WalletVirtuelMouvements` (`IdWalletVirtuelMouvement`) ON DELETE SET NULL
) CHARACTER SET=utf8mb4;
...
CREATE INDEX `IX_PerceptionsVirtuelles_AgentId` ON `PerceptionsVirtuelles` (`AgentId`);

CREATE INDEX `IX_PerceptionsVirtuelles_DeviseId` ON `PerceptionsVirtuelles` (`DeviseId`);

CREATE INDEX `IX_PerceptionsVirtuelles_PercepteurUtilisateurId` ON `PerceptionsVirtuelles` (`PercepteurUtilisateurId`);

CREATE INDEX `IX_PerceptionsVirtuellesLignes_AgentId` ON `PerceptionsVirtuellesLignes` (`AgentId`);

CREATE UNIQUE INDEX `IX_PerceptionsVirtuellesLignes_CollecteId` ON `PerceptionsVirtuellesLignes` (`CollecteId`);

CREATE INDEX `IX_PerceptionsVirtuellesLignes_PerceptionVirtuelleId` ON `PerceptionsVirtuellesLignes` (`PerceptionVirtuelleId`);

CREATE INDEX `IX_PerceptionsVirtuellesLignes_WalletVirtuelMouvementId` ON `PerceptionsVirtuellesLignes` (`WalletVirtuelMouvementId`);
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260629121322_PerceptionVirtuelleCollecte', '6.0.25');

COMMIT;

START TRANSACTION;

ALTER TABLE `WalletVirtuelMouvements` ADD `DeviseId` int NULL;

ALTER TABLE `WalletVirtuelMouvements` ADD `OperateurUtilisateurId` int NULL;

ALTER TABLE `WalletVirtuelMouvements` ADD `SoldeApres` decimal(18,2) NULL;

ALTER TABLE `WalletVirtuelMouvements` ADD `SoldeAvant` decimal(18,2) NULL;

ALTER TABLE `WalletsAgents` MODIFY COLUMN `RowVersion` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6);

CREATE INDEX `IX_WalletVirtuelMouvements_DeviseId` ON `WalletVirtuelMouvements` (`DeviseId`);

CREATE INDEX `IX_WalletVirtuelMouvements_OperateurUtilisateurId` ON `WalletVirtuelMouvements` (`OperateurUtilisateurId`);

ALTER TABLE `WalletVirtuelMouvements` ADD CONSTRAINT `FK_WalletVirtuelMouvements_Devises_DeviseId` FOREIGN KEY (`DeviseId`) REFERENCES `Devises` (`IdDevise`) ON DELETE RESTRICT;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260629124757_WalletVirtuelMouvementEnrichi', '6.0.25');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260629163015_DropDemandeBonEnvoiTypeDemande', '6.0.25');
...
ALTER TABLE `Antecedants` ADD `DependantId` int NULL;

CREATE INDEX `IX_Antecedants_DependantId` ON `Antecedants` (`DependantId`);

ALTER TABLE `Antecedants` ADD CONSTRAINT `FK_Antecedants_Dependants_DependantId` FOREIGN KEY (`DependantId`) REFERENCES `Dependants` (`IdDependant`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260706150010_AntecedentDependantIdNullable', '6.0.25');
...
CREATE UNIQUE INDEX `IX_Agents_EmailAgent` ON `Agents` (`EmailAgent`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260708121713_AgentEmailAgentUniqueIndex', '6.0.25');

COMMIT;

START TRANSACTION;

ALTER TABLE `Agents` DROP FOREIGN KEY `FK_Agents_Agents_SuperviseurId`;

ALTER TABLE `Agents` DROP INDEX `IX_Agents_SuperviseurId`;

ALTER TABLE `Agents` DROP COLUMN `SuperviseurId`;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260708130153_RemoveAgentSuperviseurId', '6.0.25');

COMMIT;

START TRANSACTION;

ALTER TABLE `TypeAdhesions` ADD `DeviseId` int NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260708193050_AddTypeAdhesionDeviseId', '6.0.25');

COMMIT;

START TRANSACTION;

ALTER TABLE `TarifsCotisation` ADD `LibelleTarifCotisation` varchar(255) CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260709083730_AddTarifCotisationLibelleTarifCotisation', '6.0.25');

COMMIT;

START TRANSACTION;

ALTER TABLE `TarifsCotisation` ADD `LibelleTarifCotisationNormalized` varchar(255) CHARACTER SET utf8mb4 NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260709090045_AddUniqueActiveLibelleTarifCotisation', '6.0.25');

COMMIT;

START TRANSACTION;

ALTER TABLE `BonsEnvoi` ADD `JetonMedicalId` int NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260709122908_AddBonEnvoiJetonMedicalLinkR1', '6.0.25');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260709123029_EnforceBonEnvoiJetonMedicalLinkR2', '6.0.25');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20260711085158_BonEnvoiJetonMedicalIdNullable', '6.0.25');
...
CREATE TABLE `ParametresMetier` (
    ...
    CONSTRAINT `FK_ParametresMetier_Utilisateurs_ModifieParUtilisateurId` FOREIGN KEY (`ModifieParUtilisateurId`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE SET NULL
) CHARACTER SET=utf8mb4;
