            ...
            CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                return new AdhesionWithAffilieReadDto
                {
                    ...
                    CommuneActivite = createdAffilie.CommuneActivite,
                    QuartierActivite = createdAffilie.QuartierActivite,
                    AvenueActivite = createdAffilie.AvenueActivite,
                    NumeroActivite = createdAffilie.NumeroActivite,
