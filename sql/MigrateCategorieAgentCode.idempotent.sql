-- =============================================================================
-- Migration : CategoriesAgents.Code + libellés affichés
-- =============================================================================
-- Aligné sur EF migration 20260624134551_AddCategorieAgentCode
-- Idempotent : relançable sans erreur si déjà appliqué.
--
-- Usage :
--   mysql -h <host> -u <user> -p <database> < sql/MigrateCategorieAgentCode.idempotent.sql
-- =============================================================================
