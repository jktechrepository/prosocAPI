...
-- Version corrigée : création des tables sans FK, puis ajout des contraintes
-- ========================================
...
-- ========================================
-- 1. CRÉATION DES TABLES (SANS CONTRAINTES FK)
-- ========================================

-- Provinces (pas de dépendances)
...
-- TypeAdhesions (pas de dépendances)
...
-- CategoriesAgents (pas de dépendances)
...
-- CategoriesPrestations (pas de dépendances)
...
-- CategoriesAdhesions (pas de dépendances)
...
-- Permissions (pas de dépendances)
...
-- Utilisateurs (pas de dépendances)
...
-- ZonesSociales (dépend de Communes)
...
-- Agents (dépend de CategoriesAgents et ZonesSociales)
...
-- Affilies (pas de dépendances directes)
...
-- Prestations (dépend de CategoriesPrestations)
...
-- Adhesions (dépend de Agents, Affilies, TypeAdhesions)
...
-- SouscriptionsPrestations (dépend de Affilies et Prestations)
...
-- CodesAdhesionSequences (pas de dépendances)
...
-- Collectes (dépend de Affilies, Agents, Devises, SouscriptionsPrestations)
...
-- RolePermissions (dépend de Roles et Permissions)
...
-- UserRoles (dépend de Utilisateurs et Roles)
...
ADD CONSTRAINT `FK_Communes_Provinces_ProvinceId` 
FOREIGN KEY (`ProvinceId`) REFERENCES `Provinces` (`Id`) ON DELETE CASCADE;

-- ZonesSociales -> Communes
ALTER TABLE `ZonesSociales` 
ADD CONSTRAINT `FK_ZonesSociales_Communes_CommuneId` 
FOREIGN KEY (`CommuneId`) REFERENCES `Communes` (`Id`) ON DELETE CASCADE;

-- Agents -> CategoriesAgents
ALTER TABLE `Agents` 
ADD CONSTRAINT `FK_Agents_CategoriesAgents_CategorieAgentId` 
FOREIGN KEY (`CategorieAgentId`) REFERENCES `CategoriesAgents` (`IdCategorieAgent`) ON DELETE CASCADE;

-- Agents -> ZonesSociales (nullable)
ALTER TABLE `Agents` 
ADD CONSTRAINT `FK_Agents_ZonesSociales_ZoneSocialeId` 
FOREIGN KEY (`ZoneSocialeId`) REFERENCES `ZonesSociales` (`Id`) ON DELETE SET NULL;

-- Adhesions -> Agents
ALTER TABLE `Adhesions` 
ADD CONSTRAINT `FK_Adhesions_Agents_AgentId` 
FOREIGN KEY (`AgentId`) REFERENCES `Agents` (`Id`) ON DELETE CASCADE;

-- Adhesions -> Affilies
ALTER TABLE `Adhesions` 
ADD CONSTRAINT `FK_Adhesions_Affilies_AffilieId` 
FOREIGN KEY (`AffilieId`) REFERENCES `Affilies` (`IdAffilie`) ON DELETE CASCADE;

-- Adhesions -> TypeAdhesions
ALTER TABLE `Adhesions` 
ADD CONSTRAINT `FK_Adhesions_TypeAdhesions_TypeAdhesionId` 
FOREIGN KEY (`TypeAdhesionId`) REFERENCES `TypeAdhesions` (`Id`) ON DELETE CASCADE;

-- Prestations -> CategoriesPrestations
ALTER TABLE `Prestations` 
ADD CONSTRAINT `FK_Prestations_CategoriesPrestations_CategoriePrestationId` 
FOREIGN KEY (`CategoriePrestationId`) REFERENCES `CategoriesPrestations` (`IdCategoriePrestation`) ON DELETE CASCADE;

-- SouscriptionsPrestations -> Affilies
ALTER TABLE `SouscriptionsPrestations` 
ADD CONSTRAINT `FK_SouscriptionsPrestations_Affilies_AffilieId` 
FOREIGN KEY (`AffilieId`) REFERENCES `Affilies` (`IdAffilie`) ON DELETE CASCADE;

-- SouscriptionsPrestations -> Prestations
ALTER TABLE `SouscriptionsPrestations` 
ADD CONSTRAINT `FK_SouscriptionsPrestations_Prestations_PrestationId` 
FOREIGN KEY (`PrestationId`) REFERENCES `Prestations` (`IdPrestation`) ON DELETE CASCADE;

-- Collectes -> Affilies
ALTER TABLE `Collectes` 
ADD CONSTRAINT `FK_Collectes_Affilies_AffilieId` 
FOREIGN KEY (`AffilieId`) REFERENCES `Affilies` (`IdAffilie`) ON DELETE CASCADE;

-- Collectes -> Agents
ALTER TABLE `Collectes` 
ADD CONSTRAINT `FK_Collectes_Agents_AgentId` 
FOREIGN KEY (`AgentId`) REFERENCES `Agents` (`Id`) ON DELETE SET NULL;

-- Collectes -> Devises
ALTER TABLE `Collectes` 
ADD CONSTRAINT `FK_Collectes_Devises_DeviseId` 
FOREIGN KEY (`DeviseId`) REFERENCES `Devises` (`Id`) ON DELETE SET NULL;

-- Collectes -> SouscriptionsPrestations
ALTER TABLE `Collectes` 
ADD CONSTRAINT `FK_Collectes_SouscriptionsPrestations_SouscriptionPrestationId` 
FOREIGN KEY (`SouscriptionPrestationId`) REFERENCES `SouscriptionsPrestations` (`IdSouscription`) ON DELETE SET NULL;

-- RolePermissions -> Roles
ALTER TABLE `RolePermissions` 
ADD CONSTRAINT `FK_RolePermissions_Roles_RoleId` 
FOREIGN KEY (`RoleId`) REFERENCES `Roles` (`IdRole`) ON DELETE CASCADE;

-- RolePermissions -> Permissions
ALTER TABLE `RolePermissions` 
ADD CONSTRAINT `FK_RolePermissions_Permissions_PermissionId` 
FOREIGN KEY (`PermissionId`) REFERENCES `Permissions` (`IdPermission`) ON DELETE CASCADE;

-- UserRoles -> Utilisateurs
ALTER TABLE `UserRoles` 
ADD CONSTRAINT `FK_UserRoles_Utilisateurs_UserId` 
FOREIGN KEY (`UserId`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE CASCADE;
...
-- ========================================
-- 5. ENREGISTREMENT DES MIGRATIONS
-- ========================================
