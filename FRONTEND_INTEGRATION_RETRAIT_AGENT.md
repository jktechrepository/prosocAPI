...
| POST | `/api/Caisse/session/{id}/cloturer` | Clôture fin de journée |

Si aucune session ouverte → `codeErreur: SESSION_CAISSIER_REQUISE` (400).

**Guide pas-à-pas Postman/cURL** : [`GUIDE_SESSION_CAISSE_RETRAIT_POSTMAN.md`](GUIDE_SESSION_CAISSE_RETRAIT_POSTMAN.md)
