-- =============================================
-- Script de correction de la vue V_Eleve
-- Supprime les colonnes inexistantes CapaciteEleveEcole et NombreSallesEcole
-- =============================================
...
PRINT 'Vue V_Eleve corrigée avec succès!';
